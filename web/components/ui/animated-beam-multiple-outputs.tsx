...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "group relative z-10 flex size-12 items-center justify-center rounded-full border border-white/10 bg-neutral-950 p-2",
        "transition-all duration-300 ease-out hover:shadow-[0_0_24px_-6px_rgba(0,229,255,0.45)] hover:border-[#00e5ff]/40",
        className
      )}
    >
      {children}
      {/* Inner ring overlay for subtle glow */}
      <div
        className="pointer-events-none absolute inset-0 rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100"
        style={{ boxShadow: "inset 0 0 0 1px rgba(0,229,255,0.35)" }}
      />
    </div>
  )
})
      ...
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
            <Image src="/astro@2x.png" alt="Logo" width={44} height={44} sizes="44px" priority quality={100} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={div2Ref}>
            <Image
              src="https://raw.githubusercontent.com/cosmos/chain-registry/master/juno/images/juno.svg"
              alt="Juno"
              width={28}
              height={28}
            />
          ...
          <Circle ref={div3Ref}>
            <Image
              src="https://raw.githubusercontent.com/cosmos/chain-registry/master/stargaze/images/stars.svg"
              alt="Stargaze"
              width={28}
              height={28}
            />
          ...
          <Circle ref={div4Ref}>
            <Image
              src="https://raw.githubusercontent.com/cosmos/chain-registry/master/evmos/images/evmos.png"
              alt="Evmos"
              width={28}
              height={28}
            />
          ...
          <Circle ref={div5Ref}>
            <Image
              src="https://raw.githubusercontent.com/cosmos/chain-registry/master/kujira/images/kuji.png"
              alt="Kujira"
              width={28}
              height={28}
            />
